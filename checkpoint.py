# from https://github.com/k2-fsa/icefall/blob/master/icefall/checkpoint.py
...
def save_checkpoint(
    ...
    optimizer_disc: Optional[Optimizer] = None,
    scheduler_disc: Optional[LRSchedulerType] = None,
    rank: int = 0,
) -> None:
    ...
    if scheduler_disc is not None:
        checkpoint["scheduler_disc"] = scheduler_disc.state_dict()
...
def load_checkpoint(
    ...
    load("optimizer_disc", optimizer_disc)
    load("scheduler_disc", scheduler_disc)
