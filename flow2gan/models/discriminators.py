...
from torch.nn.utils import weight_norm as weight_norm_impl
from torchaudio.transforms import Spectrogram


def weight_norm(m: nn.Module, disable: bool = True):
    # Since we are using ScaledAdam optimizer, we don't need weight-norm.
    return weight_norm_impl(m) if not disable else m
